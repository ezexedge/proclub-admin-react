  ...
  return projects.filter((project) => {
    ...
    if (query) {
      ...
      properties.forEach((property) => {
        ...
        if(project.notificacion !== null){
        if (project.notificacion[property].toLowerCase().includes(query.toLowerCase())) {
          containsQuery = true;
        }
          ...
          {!selectedBulkActions && (
            ...
            >
              <Box>
                ...
                <b>{paginatedProjects.length}</b> <b>{t('Notificaciones')}</b>
              </Box>
              <TablePagination
                component="div"
                          ...
                          <TableCell>
                            ...
                            >
                              ...
                              <TimerIcon className={classes.reloj} />
                                ...
                                {  `hora de envio ${project.notificacion && project.notificacion.hora}`}
                            ...
                            <Typography noWrap color="text.secondary" className={classes.timeReloj}>
                                {t('Fecha de envio')}:{' '}
                              {`${project.notificacion && project.notificacion.fecha}`}

                            </Typography>
                          </TableCell>
                          <TableCell  noWrap>
                            <Label color="success">
                              <Typography color="success" noWrap>{`${project && project.cantidad} usuarios`}</Typography>
                            </Label>
                          </TableCell>
                            ...
                            <Typography noWrap>
                              <Tooltip title={t('Ver')} arrow>
                                <IconButton
                                  ...
                                  to={'/admin/dashboard/notificacion/' + project.notificacionId}
      ...
      >
        ...
        >
          ...
          <Typography align="center" sx={{ pt: 4, px: 6 }} variant="h1">
            {t('¿De verdad quieres eliminar esta notificación')}?
          </Typography>
          ...
          <Typography
            ...
            variant="h3"
          >
            {t("No podrás revertir después de la eliminación")}
          </Typography>
