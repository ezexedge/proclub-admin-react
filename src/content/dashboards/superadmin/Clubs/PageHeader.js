...
function PageHeader({actualizarClub}) {
...
<Typography variant="h1"> Club </Typography>
<div className={classes.texto}>{'Todos los aspectos relacionados con los clubs de la aplicación se pueden gestionar desde esta página.'}</div>
    </Grid>
        ...
        >
          {({
            ...
            <>
               ...
               <RegisterWizard onchange={(e) => { onchange(e) }} />
