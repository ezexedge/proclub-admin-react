...
import {eliminarEspacio} from 'src/api/espacio'
...
const applyFilters = (projects, query, filters) => {
  return projects.filter((project) => {
    ...
    if (query) {
      const properties = ['nombre','activo'];
...
const Results = ({ users,actualizarChange, ...rest }) => {
  ...
  const handleDeleteCompleted = async () => {
    setOpenConfirmDelete(false);
     ...
     const result =  await eliminarEspacio(eliminarId,token)
            ...
            <>
                ...
                <Table>
                  ...
                  <TableBody>
                    {paginatedUsers.map((user) => {
                      ...
                      return (
                        <TableRow hover key={user.id} selected={isUserSelected}>
                          ...
                          <TableCell>
                            ...
                            <Typography className={classes.deporte} ml={2} >{user && user.nombre}</Typography>
                            </Box>
                          </TableCell>
                          <TableCell >
                      ...
                      <Label color={user && user.activo === 'activo' ? "success" : "error"}  >
                            ...
                            <Typography noWrap>
                              <Tooltip title={t('Ver')} arrow>
                                <IconButton
                                  ...
                                  to={'/admin/dashboard/espacio/' + user.id}
              ...
              <Box p={2}>
                <TablePagination
                  ...
                  labelRowsPerPage="Espacios por página"
                />
              </Box>
            </>
          )}
