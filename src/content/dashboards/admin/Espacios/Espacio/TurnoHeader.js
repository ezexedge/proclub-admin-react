...
<Typography className="turnosTitle" variant="h1"> Turnos </Typography>
<div className="turnoSubtitle">{'All aspects related to the app users can be managed from this page'}</div>
    </Grid>
    <Grid item lg={3} xs={12}  >
        ...
        component={Link} to={`/admin/dashboard/espacio/${userId}/configuracion`} 
      >
Configurar turnos
      </Button>
      </Grid>
            ...
            <form onSubmit={handleSubmit}>
              <DialogContent dividers sx={{ p: 9 }}>
                ...
                className="avatarEspacio"
                    ...
                    fullWidth id="outlined-search" label="Visibilidad" placeholder="Seleccione una visibilidad..." type="search" variant="outlined" />
                    </Box>
                    </Grid>
