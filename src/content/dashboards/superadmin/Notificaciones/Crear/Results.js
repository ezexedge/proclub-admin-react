...
const Results = ({ users,onchangeEliminar, ...rest }) => {
 ...
 if(selectedItems.length > 0){
        ...
        console.log('es el arr')
          onchangeEliminar(selectedItems)
      }else{
      onchangeEliminar(eliminarId)
 ...
 className={classes.searchBox}
            ...
            {selectedBulkActions && <BulkActions onchangeConfirm={(e) => { onchangeConfirm(e) }} />}
          </Box>
          ...
          {paginatedUsers.length === 0 ? (
            <>
              <Typography
                ...
                align="center"
              >
                {t("No existen usuarios para esta selección")}
              </Typography>
            </>
          ) : (
            <>
                          ...
                          <TableCell>
                            <Box display="flex" alignItems="center">
                              ...
                              <Box  className={classes.deporte}>
                                  {user  && user.usuario !== null && user.usuario.persona !== null ?   user.usuario.persona.nombre : 'no ingreso'  }   {user  && user.usuario !== null && user.usuario.persona !== null ?   user.usuario.persona.apellido : 'no ingreso'  }
                                
                              </Box>
                            </Box>
                          </TableCell>
                          <TableCell>
                            <Typography>{user &&  user.usuario !== null && user.usuario.persona !== null   ?  user.usuario.persona.documento :  'No ingreso'}</Typography>
                          </TableCell>
                          <TableCell align="center">
                            <Typography >
                          {user && user.usuario !== null && user.usuario.persona !== null ? user.usuario.persona.telefono : 'No ingreso' }
                            </Typography>
                          </TableCell>
                          <TableCell>
