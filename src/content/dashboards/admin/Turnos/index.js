...
import {getEspacioByClub} from 'src/api/espacio'
import {
  Grid,
  Drawer,
  useTheme,
...
function ApplicationsCalendar() {
  ...
  return (
    <>
      <ContentWrapper title="Turnos">
        <PageTitleWrapper>
          <PageHeader espacio={espacio} handleCreateEvent={handleAddClick} />
        </PageTitleWrapper>
        <Container maxWidth="lg">
          <Grid
            ...
            spacing={3}
          >
               <Grid item xs={12} className="marginBuscador-turno">
       <Card sx={{ p: 1 }}>
