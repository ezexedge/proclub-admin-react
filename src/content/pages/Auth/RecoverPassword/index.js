...
function RecoverPasswordBasic() {
  ...
  return (
    <>
      <ContentWrapper title="Recuperar contraseña">
      <Content  >

        <MainContent  >
          <Container className={classes.back} >
          
            <Card sx={{ mt: 3, p: 4 }}  className={classes.card} >
              <Box>
           ...
           type="submit" variant="outlined"> {loading ?  <CircularProgress size={21}  /> : 'Enviar'} </Button>
      ...
      >
        <Box sx={{ px: 4, pb: 4, pt: 10 }}>
          ...
          <Typography align="center" sx={{ py: 4, px: 10 }} variant="h2">
            {t('Revise su correo electrónico para obtener más instrucciones.')}
          </Typography>
          ...
          <Button
            ...
            href="/login"
          >
            {t('Continuar para iniciar sesión.')}
          </Button>
        </Box>
      </DialogWrapper>
    </>
