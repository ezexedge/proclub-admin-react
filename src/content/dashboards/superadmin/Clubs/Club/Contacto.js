...
import {
 ...
 import { useSnackbar } from 'notistack';
  ...
  function Contacto({datos,actualizarClub}) {
  ...
  const handleChangeInformacion = (e) => {
    ...
    //    setModificarNombre(param.nombre)
      ...
      useEffect(()=>{
        ...
        facebook: datos && datos.facebook ? datos.facebook : '',
        twitter:  datos && datos.twitter ? datos.twitter : '',
        instagram: datos && datos.instagram ? datos.instagram : '' 
    })
      ...
      const agregar = async() => {
        ...
        const val = {
            ...
            email: nuevosValores && nuevosValores.email,
            telefono: nuevosValores && nuevosValores.telefono,
            cuit: datos && datos.cuit,
            instagram:  nuevosValores && nuevosValores.instagram,
            facebook: nuevosValores && nuevosValores.facebook,
            twitter: nuevosValores && nuevosValores.twitter,
            cp: datos && datos.cp,
            direccion: {
              calle: datos && datos.direccion && datos.direccion.calle,
              numero: datos && datos.direccion && datos.direccion.numero,
              localidad: datos && datos.direccion && datos.direccion.localidad,
              provinciaId: datos && datos.direccion && datos.direccion.provinciaId
            }
      ...
      >
        <Fade in={openModificar}>
          <div className={classes.paper}>
            ...
            <Grid xs={12}>
          <TextField  id="outlined-basic" fullWidth label="Telefono" name="telefono" defaultValue={datos && datos.telefono}  onChange={handleChangeInformacion} variant="outlined" />

            </Grid>
            
            <Grid xs={12} mt={3}>
          <TextField  id="outlined-basic" fullWidth name="email" label="Email" defaultValue={datos && datos.email} onChange={handleChangeInformacion} variant="outlined" />

            </Grid>

            <Grid xs={12} mt={3}>
          <TextField  id="outlined-basic" fullWidth label="Facebook" name="facebook" defaultValue={datos && datos.facebook } onChange={handleChangeInformacion} variant="outlined" />

            </Grid>

            <Grid xs={12} mt={3}>
          <TextField  id="outlined-basic" fullWidth name="twitter" label="Twitter" defaultValue={datos && datos.twitter} onChange={handleChangeInformacion} variant="outlined" />

            </Grid>

            <Grid xs={12} mt={3}>
          <TextField  id="outlined-basic" fullWidth name="instagram" label="Instagram" defaultValue={datos && datos.instagram } onChange={handleChangeInformacion} variant="outlined" />
