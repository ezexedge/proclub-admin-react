...
<Typography variant="h1"> Encuestas </Typography>
<div className={classes.texto}>{'Todos los aspectos relacionados con encuestas de la aplicación se pueden gestionar desde esta página.'}</div>
    </Grid>
    <Grid item lg={5} xs={12}  display="flex"
    ...
    <Button
        ...
        component={RouterLink} to="/admin/dashboard/encuesta/nuevo/crear"
