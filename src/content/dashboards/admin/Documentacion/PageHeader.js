...
<Typography variant="h1">Documentación</Typography>
<div className={classes.texto}>{'Todos los aspectos relacionados con documentación de usuarios de la aplicación se pueden gestionar desde esta página.'}</div>
    </Grid>
