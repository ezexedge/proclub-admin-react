          ...
          <Grid item xs={12}>
            <Box p={1}>
              <TextField
                ...
                placeholder={t('Buscar encuestas o notificaciones...')}
                value={query}
                fullWidth
                variant="outlined"
              />
            ...
            <>
              <TableContainer>
                <Table>
                          ...
                          <TableCell>
                            ...
                            >
                              ...
                              <TimerIcon className={classes.reloj} />
                                ...
                                {  `hora de envio ${project && project.hora}`}
                  ...
                  <TableCell  noWrap>
                                <Label color="success">
                              <Typography color="success" noWrap>54 users</Typography>
                              </Label>
                          </TableCell>
                            ...
                            <Typography noWrap>
                              <Tooltip title={t('View')} arrow>
                                <IconButton 
                                 ...
                                 to={'/superadmin/dashboard/notificacion/' + project.id}
