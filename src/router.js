...
const routes = [
  {
    ...
    routes: [
      ...
      {
        exact: true,
        path: '/superadmin/dashboard/encuesta',
        component: lazy(() => import('src/content/dashboards/superadmin/Encuestas'))
      },
      {
        exact: true,
      ...
      {
        exact: true,
        path: '/superadmin/dashboard/encuesta/nuevo/crear',
        component: lazy(() => import('src/content/dashboards/superadmin/Encuestas/Crear'))
      },
      {
        exact: true,
        path: '/superadmin/dashboard/encuesta/:userId',
        component: lazy(() => import('src/content/dashboards/superadmin/Encuestas/Single'))
      },
      {
        exact: true,
      ...
      {
        exact: true,
        path: '/superadmin/dashboard/usuario/:userId',
  ...
  },
  {
    ...
    routes: [
      ...
      {
        exact: true,
        path: '/admin/dashboard/espacio/:userId/configuracion',
        component: lazy(() => import('src/content/dashboards/admin/Espacios/Espacio/Configuracion'))
      },
      {
        exact: true,
      ...
      {
        exact: true,
        path: '/admin/dashboard/notificacion/nuevo/crear',
        component: lazy(() => import('src/content/dashboards/admin/Notificaciones/Crear'))
      },
      {
        exact: true,
        path: '/admin/dashboard/notificacion/:userId',
        component: lazy(() => import('src/content/dashboards/admin/Notificaciones/Single'))
      },

      {
        exact: true,
        path: '/admin/dashboard/encuesta',
        component: lazy(() => import('src/content/dashboards/admin/Encuestas'))
      },
      {
        exact: true,
        path: '/admin/dashboard/encuesta/nuevo/crear',
        component: lazy(() => import('src/content/dashboards/admin/Encuestas/Crear'))
      },
      {
        exact: true,
      ...
      },
      {
        ...
        component: lazy(() => import('src/content/dashboards/admin/Usuarios/Usuario'))
      },
