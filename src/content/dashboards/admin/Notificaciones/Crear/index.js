...
console.log('valueeee',value)
    ...
    const dispararEliminar = () => {
      ...
      const onchangeEliminar = (data) => {
        console.log('id eliminar',data)
        setEliminarId(data)
      ...
      function handleChangeEliminar(newValue) {
      setValue(newValue);
    }
        ...
        <Fade in={open}>
          ...
          (
            ...
            <CheckCircleOutlineIcon className={classes.iconSize}/>
                  ...
                  <Button mt={10}  onClick={handleClose}  variant="contained" color="secondary"  disableElevation>
                        cerrar
                </Button>
         
                
                <Button mt={10} variant="contained" color="primary" onClick={cambiar} disableElevation
                   component={RouterLink} to={`/admin/dashboard/notificacion/${notificacion}`}
...
>
  ...
  <Grid  xs={3.2}  className="card-notificacion">
    ...
    <Grid item xs={12} mt={4} mb={5}>
                <AdditionalInfo eliminarId={eliminarId} disparar={()=>dispararEliminar()}   data={valueResult} onchangeResult={(e) => { onchangeResult(e) }} />
...
<Typography color="secondary" >{'Revisá la lista antes de enviar'}</Typography>
    ...
    <Card >
      <Results users={valueResult}  onchangeEliminar={(e) => { onchangeEliminar(e) }}/>
        </Card>
      </Grid>
      <Grid item lg={12} xs={12}  >
