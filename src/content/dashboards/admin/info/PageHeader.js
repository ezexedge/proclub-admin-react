...
<div className={classes.texto}>{'Todos los aspectos relacionados con información útil de la aplicación se pueden gestionar desde esta página.'}</div>
    </Grid>
    <Grid item lg={3} xs={12}  >
        ...
        component={RouterLink} to="/admin/dashboard/info/crear"
