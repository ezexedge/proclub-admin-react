...
import {deleteDeportes} from 'src/api/deportes'
...
const Results = ({ users, ...rest }) => {
  ...
  const handleDeleteCompleted = async () => {
    ...
    try{
      ...
      await deleteDeportes(eliminarId)
 ...
 className={classes.searchBox}
                ...
                placeholder={t('Buscar un espacios...')}
                value={query}
                size="small"
                fullWidth
                margin="normal"
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell >{t('Ingresos semanales')}</TableCell>
                      <TableCell>{t('Visibilidad ')}</TableCell>
                      <TableCell>{t('Qr ingreso')}</TableCell>
                  ...
                  <TableBody>
                    {paginatedUsers.map((user) => {
                      ...
                      return (
                        <TableRow hover key={user.id} selected={isUserSelected}>
                          ...
                          <TableCell>
                            ...
                            <Avatar alt="Remy Sharp" src="https://images.unsplash.com/flagged/photo-1557898246-9fd78587bcc7?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80" />

                            
                            <Typography className={classes.deporte} ml={2} >{user && user.disciplina.nombre}</Typography>
                            </Box>
                          </TableCell>
                          <TableCell >
                      ...
                      <Label color="success" >PUBLICO</Label>
                    </Box>
                          </TableCell>
                          <TableCell align="center"noWrap >
                          <span class="material-icons-outlined colorIconEspacio">
                          qr_code
                          </span>
                      ...
                      <Label color="success" >HABILITADO</Label>
                    </Box>
                          </TableCell>
                            ...
                            <Typography noWrap>
                              <Tooltip title={t('Ver')} arrow>
                                <IconButton
                                  ...
                                  to={'/admin/dashboard/espacio/' + user.disciplinaId}
