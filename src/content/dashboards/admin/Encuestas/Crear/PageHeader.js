...
<Typography variant="h1"> Crear encuesta </Typography>
<Typography color="secondary" >{'Todos los aspectos relacionados con encuestas de la aplicación se pueden gestionar desde esta página.'}</Typography>
    </Grid>
