...
<Typography variant="h1"> Crear notificación </Typography>
<Typography color="secondary" >{'Ingresa título, descripción y configura la lista de envío de notificaciones.'}</Typography>
    </Grid>
