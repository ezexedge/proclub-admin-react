...
import { deleteUsuario , deleteUsuarioSuperAdmin} from 'src/api/usuarios'
...
const Results = ({ users,actualizarUser, ...rest }) => {
  ...
  const llamadaDeportes = async (param) => {
    let result = await getAllDeportesXUsuario(param)
    // console.log(result)
    setDeportes(result)
  }
  ...
  useEffect(() => {
    ...
    llamadaDeportes(token)


  },[])

  let valor = 'eliminado'
  console.log('test',valor.includes('activo'))
  ...
  const handleDeleteCompleted =  async() => {
      ...
      setOpenConfirmDelete(false);
        ...
        const result = await deleteUsuarioSuperAdmin(eliminarId,token)
                          ...
                          <TableCell>
                            <Box display="flex" alignItems="center">
                              ...
                              <Box className={classes.deporte}>
                                {user && user.persona !== null ? user.persona.nombre : 'no ingreso'}   {user && user.persona !== null ? user.persona.apellido : 'no ingreso'}

                              </Box>
                            </Box>
                          </TableCell>
                          <TableCell>
                            <Typography>{user && user.persona !== null ? user.persona.documento : 'No ingreso'}</Typography>
                          </TableCell>
                          <TableCell align="center">
                            <Typography >
                              {user && user.persona !== null ? user.persona.telefono : 'No ingreso'}
                            </Typography>
                          </TableCell>
                          <TableCell>
                            ...
                            <Typography noWrap>
                              <Tooltip title={t('Ver')} arrow>
                                <IconButton
                                  ...
                                  to={'/superadmin/dashboard/usuario/' + user.id}
                                  color="primary"
